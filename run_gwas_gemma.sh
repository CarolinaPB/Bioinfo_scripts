...
## Starter VCF
# VCF=/lustre/backup/WUR/ABGC/shared/ABGC_Projects/Meagre/gbs-genetic-fitness/results/meagre_FastGBS_platypus.recode.vcf.gz

## Create PED files from VCF
# plink --vcf $VCF --make-bed --out meagre --double-id --allow-extra-chr
...
gemma -bfile meagre -gk 1 -o meagre_rel_matrix
gemma -bfile meagre -k output/meagre_rel_matrix.cXX.txt -lmm 4 -o gwas_gemma
...
# Rscript ../plot_assoc.R output.pdf output/gwas_gemma.assoc.txt "Granulomas Vs control"
